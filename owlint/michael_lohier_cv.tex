...
\begin{center}
    ...
    {\LARGE \scshape Développeur Bakend Python} \\ \vspace{3pt}
    \small
...
\section{Expériences professionnelles}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {6WIND}{Paris, France}
      {Développeur Bakend Python (2.5 années)}
      {Mai 2021 \textbf{--} Présent, CDI}
        ...
        \resumeItemListStart
            \resumeItem{
              ...
              Elasticsearch, Prometheus, CloudWatch...) encryptés par TLS/SSL.
            }
            \resumeItem{
            ...
            \resumeItem{
              Développement de diverses tests: unitaires et d'intégration
              impliquant des topologies de VMs.
            }
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Octobre 2020 \textbf{--} Mars 2021, CDD}
        ...
        \resumeItemListStart
            ...
            \resumeItem{
              Collaboration avec une equipe remote pour mener un projet à terme
              en suivant la methode Agile et les Scrums.
            }
        \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Développement Python:}{
          Django, Django REST Framework, Flask, FastAPI, Unittest, Asyncio
        } \\ \vspace{3pt}
        ...
        \textbf{Ingénierie data:}{
          Elasticsearch, InfluxDB, Apache Kafka, Prometheus, Graphite, Grafana,
          Microsoft PowerBI
        } \\ \vspace{3pt}
        \textbf{Langues:}{
