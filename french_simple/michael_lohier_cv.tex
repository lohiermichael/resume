...
\begin{center}
    ...
    \raggedright
    \vspace{10pt}
    Ayant plus de 3 ans d'expérience dans le développement Python, je suis à la
    recherche d'un poste de développeur backend. Mon expertise inclut le
    développement web avec Django, la conception d'API, et l'intégration de
    systèmes. Passionné par les technologies, je suis toujours prêt à relever de
    nouveaux défis et à contribuer au succès des projets.
...
\section{Expériences professionnelles}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {6WIND}{Paris, France}
      {Développeur Python (2.5 années)}
      {Mai 2021 \textbf{--} Présent, CDI}

        \resumeItemListStart
            \resumeItem{
              Développement d'une API Python pour l'export de metriques via
              Telegraf vers mutliples outils de monitoring (Apache Kafka,
              Elasticsearch, Prometheus...)
            }
            \resumeItem{
              Developpement d'un interface en ligne de commande (CLI) en Python
              et Bash.
            }
            \resumeItem{
    ...
    \resumeSubheading
      ...
      {Octobre 2020 \textbf{--} Mars 2021, CDD}
        ...
        \resumeItemListStart
            \resumeItem{
              Developpement d'un application Angular deployee sur Google Cloud
              en charge du calcul de prix du gaz europeen.
            }
            \resumeItem{
              Maintenance d'une application Python/Angular en charge du moniotoring
              de crawlers web.
            }
            % \resumeItem{
    ...
    \resumeSubheading
      ...
      {Mars 2019 \textbf{--} Septembre 2019, Stage }
        ...
        \resumeItemListStart
            \resumeItem{
              Conception d'un pipeline ETL automatisée avec Azure Databricks
              (Pyspark)
            }
            \resumeItem{
              Elaboration de tests de simulation pour une application de
              détection de pannes sur platformes gazières.
            }
            \resumeItem{
              Conception de prototypes de dashboards PowerBI en réponse à
              un appel d'offre lors d'une mission de consulting.
            }
        \resumeItemListEnd
